...
var premadeRanges = {
    "Last 7 Available Days": [
        moment(dataEndDate, "MM/DD/YYYY").subtract(6, "days"),
        moment(),
    ],
    "Last 30 Available Days": [
        moment(dataEndDate, "MM/DD/YYYY").subtract(29, "days"),
        moment(),
    ],
    "Last 3 Available Months": [
        moment(dataEndDate, "MM/DD/YYYY").subtract(3, "months"),
        moment(),
    ],
    "Last Available Year": [
        moment(dataEndDate, "MM/DD/YYYY").subtract(1, "years"),
        moment(),
    ],
};

var last30Days =
    moment(dataEndDate, "MM/DD/YYYY")
        .subtract(30, "days")
        .format("MM/DD/YYYY") +
    " - " +
    moment(dataEndDate, "MM/DD/YYYY").format("MM/DD/YYYY");
