...
def renderRawQueryPage(request: HttpRequest, context, form, queryResults: list = None, errorMessage: str = None):
    context.update({'queryResults': queryResults, 'form':form, 'errorMessage': errorMessage})
