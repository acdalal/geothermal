"""
Django settings for geothermalsite project.
...
SECRET_KEY = "django-insecure-hlj8d2*isy+^k(tlm(-u-iaw^)gw(e7huvl-@07ra0$m&zyn%8"
...
WSGI_APPLICATION = "geothermalsite.wsgi.application"
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, "webpack/dist")]
STATIC_URL = "/static/"
